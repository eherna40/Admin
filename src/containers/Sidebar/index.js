          ...
          <div className="scroll">
            ...
            >
              <Nav vertical className="list-unstyled">
                ...
                <NavItem
                  className={classnames({
                    active: ((this.state.selectedParentMenu == "offerts" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="offerts")
                  })}
                >
                  <NavLink
                    to="/app/offerts/all"
                    onClick={e => this.openSubMenu(e, "offerts")}
                  >
                    <i className="iconsmind-Tag" />{" "}
                    Offertas
                  </NavLink>
                </NavItem>
                <NavItem
                  className={classnames({
                    active: ((this.state.selectedParentMenu == "shops" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="shops")
                  })}
                >
                  <NavLink
                    to="/app/shops/all"
                    onClick={e => this.openSubMenu(e, "shops")}
                  >
        ...
        <div className="sub-menu">
          <div className="scroll">
            ...
            >
              ...
              <Nav
                className={classnames({
                  "d-block": ((this.state.selectedParentMenu == "shops" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="shops")
                })}
                data-parent="shops"
              >
                <NavItem>
                  <NavLink to="/app/shops/all">
                    Ver todos
                  </NavLink>
                </NavItem>
              ...
              <Nav
                className={classnames({
                  "d-block": ((this.state.selectedParentMenu == "offerts" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="offerts")
                })}
                data-parent="offerts"
              >
                <NavItem>
                  <NavLink to="/app/offerts/all">
                    Ver todos
                  </NavLink>
                </NavItem>
